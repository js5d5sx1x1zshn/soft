...
public class CompletedOrder extends Activity{
	/** volley对象*/
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.complete_activiy);
...
//				textViewOrderid.setText(text);
				break;
			case 1:
				Toast.makeText(CompletedOrder.this, "请检查网络连接", Toast.LENGTH_SHORT).show();
				break;
			case 2:
				Toast.makeText(CompletedOrder.this, "取消申请已提交", Toast.LENGTH_SHORT).show();
				finish();
				break;
			case 3:
				Toast.makeText(CompletedOrder.this, "取消失败", Toast.LENGTH_SHORT).show();
				break;
			case 4:
				Toast.makeText(CompletedOrder.this, "支付申请已提交到后台", Toast.LENGTH_SHORT).show();
				break;
			case 5:
				Toast.makeText(CompletedOrder.this, "申请待审核", Toast.LENGTH_SHORT).show();
				break;
			case 6:
				Toast.makeText(CompletedOrder.this, "提交失败", Toast.LENGTH_SHORT).show();
				break;
			default:
