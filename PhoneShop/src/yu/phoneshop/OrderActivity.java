...
//				textViewOrderid.setText(text);
				break;
			case 1:
				Toast.makeText(OrderActivity.this, "请检查网络连接", Toast.LENGTH_SHORT).show();
				break;
			case 2:
				Toast.makeText(OrderActivity.this, "取消申请已提交", Toast.LENGTH_SHORT).show();
				finish();
				break;
			case 3:
				...
				break;
			case 4:
				Toast.makeText(OrderActivity.this, "支付申请已提交到后台", Toast.LENGTH_SHORT).show();
				break;
			case 5:
				Toast.makeText(OrderActivity.this, "申请待审核", Toast.LENGTH_SHORT).show();
				break;
			case 6:
